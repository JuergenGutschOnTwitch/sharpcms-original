  ...
  <xsl:template name="topelements">
	...
	<xsl:template mode="formelement" match="item[@type='tinymce']">
      ...
      <br style="clear:both" />
        ...
        <textarea style="width:550px;height:200px" class="mceeditor" name="{$id}_{@attribute}">
          <xsl:if test="@height">
            <xsl:attribute name="style">
              <xsl:text>width:550px;height:</xsl:text>
	...
	<xsl:template mode="formelement" match="item[@type='textarea']">
		...
		<div class="item-type">
			...
			<textarea style="width:550px;height:150px" name="{$id}_{@attribute}">
				<xsl:value-of select="$currentelement/*[name()=$attribute]"/>
			</textarea>
		</div>
	</xsl:template>
  ...
  <xsl:template mode="formelement" match="item[@type='statuslist']">
	...
	<xsl:template mode="formelement" match="item[@type='date']">
		...
		<div class="item-type">
			...
			<input type="text" size="2" style="width: 2em;">
				<xsl:attribute name="name">
			...
			<xsl:text> </xsl:text>
			<input type="text" size="4" style="width: 4em;">
				<xsl:attribute name="name">
